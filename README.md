...
[cosanguine](https://github.com/lbonanomi/scripts/blob/master/cosanguine.py): Cosine text-similarity of globs. Thank you to vpekar @ StackOverflow for the math.
