...
[jacquard.py](https://github.com/lbonanomi/scripts/blob/master/jacquard.py): A debt collection tool that compares the similarity of files from ARGV using jacquard indices.
