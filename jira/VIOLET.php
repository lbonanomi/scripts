                ...
                foreach ($source_issue_json as $source_issue) {
                        ...
                        if (is_array($incompletes)) {
                                foreach ($incompletes as $incomplete_item) {
                                        ...
                                        print "*SIGH* translate($source_instance, $dest_instance, $key)\n\n";

                                        $new_key = translate($source_instance, $dest_instance, $key);

                                        //print "GET BACK $new_key\n\n";

                                        if (strlen($new_key)) {
                                                ////print "SHOVE ISSUE $key TO SPRINT AS $new_key. EXPECT TO FAIL. YOU MUST TRANSLATE THAT TO THE NEW KEY!\n";
